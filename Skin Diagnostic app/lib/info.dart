      ...
      body: Column(
        children: <Widget>[
          ...
          if(category != null){
            ...
            if(category!.label == 'Melanoma (mel)'||category!.label == 'Basal cell carcinoma (bcc)'){
              checkNull = true;
              return '**warning**';
            }
            else{
          ...
          Text(
            ...
            style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: checkNull != true ? Colors.black : Colors.red),
          ),
          SizedBox(
            height: 8,
          ),
